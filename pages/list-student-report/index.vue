<template>
	<v-container fluid>
		<v-row>
			<v-col cols="12">
				<h1>Listado de entrega de reportes</h1>
			</v-col>
			<v-col cols="12" class="pt-0">
				<BaseDataTable
					...
					<template #[`item.report1`]="{ item }">
						<div class="d-flex align-center py-2">
							<v-icon v-if="item.report1==true" class="d-flex align-center py-2" color="green">
								mdi-check-circle-outline
							</v-icon>
							<v-icon v-else class="d-flex align-center py-2" color="red">
								mdi-close-circle-outline
							</v-icon>
						</div>
					</template>
					<template #[`item.report2`]="{ item }">
						<div class="d-flex align-center py-2">
							<v-icon v-if="item.report2==true" class="d-flex align-center py-2" color="green">
								mdi-check-circle-outline
							</v-icon>
							<v-icon v-else class="d-flex align-center py-2" color="red">
								mdi-close-circle-outline
					...
					<template #[`item.report3`]="{ item }">
						<div class="d-flex align-center py-2">
							<v-icon v-if="item.report3==true" class="d-flex align-center py-2" color="green">
								mdi-check-circle-outline
							</v-icon>
							<v-icon v-else class="d-flex align-center py-2" color="red">
								mdi-close-circle-outline
					...
					<template #[`item.report4`]="{ item }">
						<div class="d-flex align-center py-2">
							<v-icon v-if="item.report4==true" class="d-flex align-center py-2" color="green">
								mdi-check-circle-outline
							</v-icon>
							<v-icon v-else class="d-flex align-center py-2" color="red">
								mdi-close-circle-outline
